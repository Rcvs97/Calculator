...
//		setting up the backspace button and adding action listener on it
...
//		setting up the numeric buttons
...
//		checking and perform the selected operation on given values
		JButton btnEqual = new JButton("=");
		btnEqual.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				String answer;
				second=Double.parseDouble(textField.getText());
//				performing addition operation here
				if(operation=="+")
				{
					result=first+second;
...
//				performing subtraction operation here
				else if(operation=="-")
				{
					result=first-second;
					answer=String.format("%.2f", result);
...
//				performing multiplication operation here
				else if(operation=="*")
				{
					result=first*second;
					answer=String.format("%.2f", result);
...
//				performing division operation here
				else if(operation=="/")
				{
					result=first/second;
					answer=String.format("%.2f", result);
...
//				performing modulo operation here
				else if(operation=="%")
				{
					result=first%second;
					answer=String.format("%.2f", result);
...
//		Setting up the operational buttons and Adding action listener on them
